...
const SCRIPT: { who: "Kunde" | "AI"; text: string }[] = [
    ...
    <div ref={ref} className="card relative overflow-hidden p-5 sm:p-7">
      <div className="mb-5 flex items-center gap-3">
        ...
        <div className="flex-1">
          <p className="text-sm font-semibold">Indgående opkald · Bella Napoli</p>
        ...
        {done && (
          <div className="animate-pop rounded-2xl border border-emerald-400/30 bg-emerald-400/10 p-4">
            <p className="flex items-center gap-2 font-semibold text-emerald-300">
              <Icon name="check" className="h-5 w-5" /> Ordre oprettet ✓
            </p>
            <p className="mt-1 text-sm text-white/80">1 × Pepperoni · 1 × Hawaii (+ ekstra ost) · Levering til 1650</p>
